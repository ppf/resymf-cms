...
class PageFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $admin = $this->getReference(UserFixtures::USER_ADMIN, User::class);

        // Get categories
        $newsCategory = $this->getReference(CategoryFixtures::CATEGORY_NEWS, Category::class);
        $blogCategory = $this->getReference(CategoryFixtures::CATEGORY_BLOG, Category::class);
        $docsCategory = $this->getReference(CategoryFixtures::CATEGORY_DOCS, Category::class);
